...
{
	DER_ItAsn1_ReadInteger(m_header, (EASY_UINT32 *)&iValue);
...
{
	DER_ItAsn1_ReadInteger(m_next, (EASY_UINT32 *)&iValue);
	m_next = m_next->next;
	return 0;
}
...
{
	DER_EASY_String_To_AnyBuf(&m_temp, (unsigned char *)inData, inLen);
...
void SequenceASN1::freeSequence(EASY_ANYBUF * node)
{
